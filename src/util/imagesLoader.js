 ...
 * @private
 */
 function ol_ext_imageLoader_loadBILImage(src, onload, onerror) {
  var size = [
 ...
 * @private
 */
 function ol_ext_imageLoader_loadImage(src, onload, onerror) {
  var xhr = new XMLHttpRequest();
  xhr.responseType = 'blob';
  xhr.addEventListener('loadend', function () {
    var resp = this.response;
 ...
 */
function ol_ext_imageLoader_pixelTransform(setPixel) {
 ...
 * @returns {function} an ol/Tile~LoadFunction
 */
function ol_ext_imageLoader_grayscale() {
 ...
 * @returns {function} an ol/Tile~LoadFunction
 */
function ol_ext_imageLoader_transparent(colors) {
  var color1, color2;
 ...
 * @returns {function} an ol/Tile~LoadFunction
 */
function ol_ext_imageLoader_seaLevelMap(level, options) {
  options = options || {};
 ...
 * @private
 */
 function ol_ext_imageLoader_shadedRelief() {
 ...
 */
function ol_ext_getPixelFromElevation(height) {
 ...
 */
function ol_ext_getElevationFromPixel(pixel) {
