...
class ol_source_WikiCommons {
  constructor(opt_options) {
    ...
    if (!options.attributions)
      options.attributions = ["&copy; <a href='https://commons.wikimedia.org/'>Wikimedia Commons</a>"];
...
ol_ext_inherits(ol_source_WikiCommons, ol_source_Vector);
