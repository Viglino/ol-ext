...
*/
ol_interaction_Transform.prototype.select = function(feature)
...
ol_interaction_Transform.prototype.handleDownEvent_ = function(evt)
{
	...
	{	this.mode_ = sel.handle;
		...
		this.extent_ = (ol_geom_Polygon.fromExtent(this.geom_.getExtent())).getCoordinates()[0];
		this.center_ = ol_extent.getCenter(this.geom_.getExtent());
